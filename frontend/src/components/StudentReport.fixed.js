...
const StudentReport = () => {
  ...
  // Set up a listener that will refresh the reports whenever this component gains focus
  useEffect(() => {
  ...
  return (
    <div id="reports-container" className="container mx-auto px-4 py-8" key={key}>
      ...
      {/* Add test component that will make a direct API call */}
      <TestApiReport />
            ...
            <div className="mb-4 p-3 bg-gray-100 rounded-lg text-xs">
              <details>
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p>Token refreshed: {tokenRefreshed ? 'Yes' : 'No'}</p>
                  ...
                  <p>Auth header set: {!!apiClient.defaults.headers.common['Authorization'] ? 'Yes' : 'No'}</p>
